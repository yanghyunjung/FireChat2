...
public class FirebaseDbService implements ChildEventListener {
    ...
    public FirebaseDbService(Context context, MyRecyclerViewAdapter myRecyclerViewAdapter, ItemList itemList, String userId, RecyclerView recyclerView, BooleanCommunication checkedFreeScroll) {
    ...
    public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
                    ...
                    if (!file.exists()) {
                        ...
                        fileDownloadTask.addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                            ...
                            public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                                ...
                                myRecyclerViewAdapter.notifyItemChanged(selectIndex);
                            }
        ...
        if(itemList.get(index).getHaveVideo()){
